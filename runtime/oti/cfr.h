...
#define CFR_ACC_VALUE_TYPE					0x00000040
...
#define CFR_VNEW_METHOD_ACCESS_MASK  (CFR_ACC_PUBLIC | CFR_ACC_PRIVATE | CFR_ACC_STATIC | CFR_ACC_SYNTHETIC | CFR_ACC_VARARGS | CFR_ACC_STRICT)
