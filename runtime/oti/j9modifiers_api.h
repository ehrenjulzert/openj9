...
#define J9ROMCLASS_ALLOWS_NON_ATOMIC_CREATION(romClass)	_J9ROMCLASS_J9MODIFIER_IS_SET((romClass), J9AccClassAllowsNonAtomicCreation)
#define J9ROMCLASS_HAS_DEFAULT(romClass)		_J9ROMCLASS_J9MODIFIER_IS_SET((romClass), J9AccClassHasDefault)
